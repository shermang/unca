...
/**
 * @file
 * Display Suite UNC DS Default template.
 *
 * Available variables:
 *
 * Layout:
 ...
 */
?>
<div <?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> <?php if ($sidebar_column): ?>has-sidebar<?php endif; ?> ds-layout unc-ds-default clearfix">
