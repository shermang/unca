...
?>
  ...
  <!-- If this is NOT a gateway page, render the normal layout -->
  <?php if (!$gateway_page): ?>
    <?php include(path_to_theme().'/templates/page-normal.tpl.php'); ?>
  <?php endif; ?>

  <!-- If this IS a gateway page, render the gateway layout -->
  <?php if ($gateway_page): ?>
    <?php include(path_to_theme().'/templates/page-gateway.tpl.php'); ?>
  <?php endif; ?>
