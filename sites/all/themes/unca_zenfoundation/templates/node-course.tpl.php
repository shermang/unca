<?php $base_path = base_path();?>
 ...
 <?php } else { ?>
 <img src="../../default/files/images/Not_Available.png" width="175" alt="Project Logo" class="left profiles"/>
 <?php } ?>
 ...
 <div class="course_times"><strong>Course Times:</strong> <?php print $node->field_course_times[0]['safe']; ?></div>
