...
<a class="button-blue-rounded" href="/faces/<?php print strtolower($fields['name']->content); ?>"><span>Find out about our other <?php print strtolower($fields['name']->content); ?></span></a>
<div class="clear">&nbsp;</div>
</div>