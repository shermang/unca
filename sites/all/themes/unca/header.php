...
<div class="container">
	<div id="header"> 
		<a href="http://www.unca.edu" accesskey="1"><img src="<?php print $base_path . $directory; ?>/imgs/uncasheville-logo.png" alt="go to homepage" width="285" height="65" id="logo" /></a>
			...
			</div>	<!-- /navigation-utility-wrapper -->
		<div class="clear">&nbsp;</div>
	</div> <!-- /header -->
    <div class="clear">&nbsp;</div>
	...
	<div id="navigation-primary-wrapper">
		<ul id="navigation-primary" class="list-horizontal">
		  ...
		  <li><a href="http://news.unca.edu" id="news-and-events" >News &amp; Events</a></li>
...
<?PHP //include("http://www.unca.edu/notification-header-placeholder");?>